// Package logger shows a patern of using a buffer to handle log write
...
// New creates a logger value and initializes it for use. The user
// can pass the size of the buffer to use for continuity.
